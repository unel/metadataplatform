...
- [ ] **RE-006** — Notes/complaints как обязательный финальный шаг в write-скиллах → [crud/06-notes-complaints-mandatory](../0002-store-crud/artifacts/actions/06-notes-complaints-mandatory.md)
...
- [ ] **RE-009** — Fix-report обязателен перед переводом в done после failed → [crud/09-fix-report-mandatory](../0002-store-crud/artifacts/actions/09-fix-report-mandatory.md)
...
- [ ] **RE-035** — RFC: Харли + Agent tool для автономной оркестрации → [conn/08-harley-agent-tool-rfc](../0001-store-connection/artifacts/actions/08-harley-agent-tool-rfc.md)
- [ ] **RE-047** — Адоптировать практики из karpathy CLAUDE.md в скиллы и стандарты → [conn/09-adopt-karpathy](../0001-store-connection/artifacts/actions/09-adopt-karpathy-claude-md.md)
- [ ] **RE-036** — Обновить Go до 1.26.2 → [general/36-go-upgrade](actions/36-go-upgrade.md)
- [ ] **RE-037** — Система флоу: формат описания, инициализация скелета, next/previous-step в frontmatter → [general/37-flow-system](actions/37-flow-system.md)
...
- [ ] **RE-045** — Инструкции агентам: создавать brief/report до вызова begin/end-step → [general/45-agent-briefs-instructions](actions/45-agent-briefs-instructions.md)
- [ ] **RE-046** — Интегрировать скрипты в инструкции к скиллам и агентам → [general/46-integrate-scripts-into-instructions](actions/46-integrate-scripts-into-instructions.md)
