...
see-also: tasks/store/crud/processes/03-tests/02-review/report-004.md
status: done
agent: Азирафаль
---
...
| Маппинг AC-ENTITY-LIST-05 | В tasks/store/crud/processes/03-tests/01-write/report-001.md добавлен TestEntity_List_IgnoresNonJsonFiles рядом с TestEntity_List_TmpFilesPresent_IgnoresTmpFiles для AC-ENTITY-LIST-05. |

## Результат

`go test ./tasks/store/crud/tests/happy/...` — ok.
