...
run: 1
date: 2026-04-29T13:36:15Z
created: 2026-04-29T13:36:15Z
spec-version: 1.4.0
...
review-source: tasks/0002-store-crud/stages/02-acceptance/02-review/report-001.md
status: done
agent: Танк
---
...
**Then** роутер закрывает соединение; дальнейшие запросы в этом соединении не обрабатываются; в лог записана строка уровня ERROR содержащая поле `parse_error` с текстом ошибки парсинга
